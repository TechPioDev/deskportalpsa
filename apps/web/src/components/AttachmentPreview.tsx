...
export function AttachmentPreview({ ticketId, attachmentId, fileName, contentType, clean }: {
  ticketId: string;
  attachmentId: string;
  fileName: string;
  contentType: string;
  ...
  return (
    <>
      <button
        ...
        className="mb-1.5 block overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--bg)] hover:border-brand"
      >
